...
SWIFT_CLASS("_TtC14FDWaveformView14FDWaveformView")
@interface FDWaveformView : UIView

/// A delegate to accept progress reporting
@property (nonatomic, weak) id <FDWaveformViewDelegate> _Nullable delegate;

/// The audio file to render
@property (nonatomic, strong) NSURL * _Nullable audioURL;

/// The total number of audio samples in the file
@property (nonatomic, readonly) NSInteger totalSamples;

/// A portion of the waveform rendering to be highlighted
@property (nonatomic) NSInteger progressSamples;

/// The first sample to render
@property (nonatomic) NSInteger zoomStartSamples;

/// One plus the last sample to render
@property (nonatomic) NSInteger zoomEndSamples;
...
@property (nonatomic, strong) UIColor * _Nonnull wavesColor;
...
@interface FDWaveformView (SWIFT_EXTENSION(FDWaveformView)) <UIGestureRecognizerDelegate>
...
SWIFT_PROTOCOL("_TtP14FDWaveformView22FDWaveformViewDelegate_")
@protocol FDWaveformViewDelegate <NSObject>
@optional

/// Rendering will begin
- (void)waveformViewWillRender:(FDWaveformView * _Nonnull)waveformView;

/// Rendering did complete
- (void)waveformViewDidRender:(FDWaveformView * _Nonnull)waveformView;

/// An audio file will be loaded
- (void)waveformViewWillLoad:(FDWaveformView * _Nonnull)waveformView;

/// An audio file was loaded
- (void)waveformViewDidLoad:(FDWaveformView * _Nonnull)waveformView;

/// The panning gesture did begin
- (void)waveformDidBeginPanning:(FDWaveformView * _Nonnull)waveformView;

/// The panning gesture did end
- (void)waveformDidEndPanning:(FDWaveformView * _Nonnull)waveformView;
@end
